...
export function updateSettlement(id: string, input: CreateSettlementInput): Promise<Settlement> {
...
export function deleteSettlement(id: string): Promise<void> {
	return api<void>(`/settlements/${encodeURIComponent(id)}`, { method: 'DELETE' });
}
